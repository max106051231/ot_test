...
set FORCE_CPU=1
set LLM_DEVICE=cpu
if "%LLM_SPEED%"=="" set LLM_SPEED=cpu_fast
...
REM 開啟 CPU grounded 直答（略過 LLM）：set LLM_CPU_FAST_GROUNDED=1
...
if "%LLM_CHAT_PRIME%"=="" set LLM_CHAT_PRIME=0
if "%LLM_CPU_FAST_GROUNDED%"=="" set LLM_CPU_FAST_GROUNDED=0
